		...
		<div id="carouselBanner" class="carousel slide pt-0" data-bs-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					...
					<img src="img/banner-homepage.jpg" alt="" class="w-100">
				</div>
				<div class="carousel-item">
					...
					<img src="img/banner-homepage-1.jpg" alt="" class="w-100">
				</div>
			</div>
		</div>
	</section>
	...
	<section class="newsHighlights bgGrey bgArrow">
		<div class="container-lg">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card">
						<a href="#"><img class="card-img-top" src="img/img-2.jpg"></a>
				...
				<div class="col-md-4">
					<div class="card">
						<a href="#"><img class="card-img-top" src="img/img-3.jpg"></a>
						<div class="card-body d-flex flex-column">
