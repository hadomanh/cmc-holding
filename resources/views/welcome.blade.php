			...
			<div class="row">
				<div class="col-md-4">
					<div class="card container1">
						<a href="#"><img class="card-img-top" src="{{ asset('img/Rectangle 10.png') }}"></a>
				...
				<div class="col-md-4">
					<div class="card container1">
						<a href="#"><img class="card-img-top" src="{{ asset('img/Rectangle 10 (1).png') }}"></a>
						<div class="card-body d-flex flex-column content">
				...
				<div class="col-md-4">
					<div class="card container1">
						<a href="#"><img class="card-img-top" src="{{ asset('img/Rectangle 10 (2).png') }}"></a>
						<div class="card-body d-flex flex-column content">
